...
df = df.drop(['rowid', 'kepler_name', 'koi_comment', 'koi_longp', 'koi_ingress', 'koi_sage', 'koi_model_dof', 'koi_model_chisq',
...
codes_df.to_csv('y_raw.csv', index=False, header=False)
...
df_nums.to_csv('x_raw.csv', index=False, header=False)
